...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul class="nav nav-tabs" id="reportTabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="detalle-servicios-tab" data-bs-toggle="tab" href="#detalle-servicios" role="tab" aria-selected="false">Detalle de Servicios</a>
        </li>
        
        <li class="nav-item">
            <a class="nav-link" id="facturacion-tab" data-bs-toggle="tab" href="#facturacion" role="tab" aria-selected="false">Resumen de Facturación</a>
        </li>
        </ul>
    ...
    <div class="tab-content" id="reportTabsContent">
        ...
        <div class="tab-pane fade" id="detalle-servicios" role="tabpanel" aria-labelledby="detalle-servicios-tab">
            <h3>Detalle de Servicios por Reparación (V_Detalle_Servicios_Por_Reparacion)</h3>
            <p>Muestra el costo unitario y el mecánico ejecutor de cada servicio asociado a una reparación.</p>
            <asp:GridView
                ID="GridViewDetalleServicios"
                runat="server"
                AutoGenerateColumns="true"
                CssClass="table table-bordered table-striped mt-3">
            </asp:GridView>
        ...
        <div class="tab-pane fade" id="facturacion" role="tabpanel" aria-labelledby="facturacion-tab">
            <h3>Resumen de Facturación (Vista: V_Resumen_Facturacion)</h3>
            <p>Muestra los totales facturados (ej. por cliente, por mes, etc.).</p>
            <asp:GridView
                ID="GridViewFacturacion"
                runat="server"
                AutoGenerateColumns="true"
                CssClass="table table-bordered table-striped mt-3">
            </asp:GridView>
